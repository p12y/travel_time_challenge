class Meeting < ApplicationRecord
  ...
  private
    ...
    def calculate_travel_time
      ...
      self.update_column(:travel_time, @travel_time)
      self.update_column(:arrival_time, @departure_time + self.travel_time.minutes)
      self.update_column(:departure_time, self.arrival_time)
      self.update_column(:departure_time, self.departure_time + self.duration.minutes)
    end
